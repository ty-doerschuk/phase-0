...
Reading driver code associated with instance methods and variables.

What is still confusing to you about Ruby?
Complex driver code. It's take a lot of mental energy to comprehend variables that are new class methods, then that variable is called with another instance variable with arguments. I think this is because I am still in the early stages of learning and easier comprehension will come with time.

What are you going to study to get more prepared for Phase 1?
Just more practice interpreting and writing driver code.
=end